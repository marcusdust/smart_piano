...
#define MAX_LED_ON_NUMBER 10
#define MAX_LED_INDEX 182
#define EMPTY_LED_INDEX (MAX_LED_INDEX + 1)
#define BYTES_PER_LED 6
...
private:
    ...
    void led_set_update(void);
    int get_led_index(int note_index);
    int led_on_list[MAX_LED_ON_NUMBER];
